...
# Pure carry-over simulation: same structure as carryover_with_gen.R but with
# no cross-stimulus generalization. Generates pure_simulation_carryover_results.RData
# used by regen_fig2.R for the main carry-over curves (Fig 2c).
# =============================================================================
...
cat("=== Carry-Over Gradient (Pure, no generalization) ===\n")
...
# Print results
cat("\n=== RESULTS (carry-over, no generalization) ===\n\n")
for (df in DECAY_FACTORS) {
  sub <- summary_all[summary_all$decay_factor == df, ]
